                ...
                <form action="../function/addprodd.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="supt" id="supt" class="form-control"
                                placeholder="EnterProduct Name..">
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="updatesup" class="btn btn-primary">Update Data</button>
                    </div>
                </form>
            ...
            <div class="modal-content">
                ...
                <form action="../function/addprodd.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="deletesup" class="btn btn-primary"> Yes</button>
                    </div>
                </form>
...
<?php } ?>
                        <h4>Supplier Details 
                            <a href="../function/addsup.php" class="btn btn-primary float-end">Add Supplier</a>
                        </h4>
                    </div>
                    <div class="card-body">
