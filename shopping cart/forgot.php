...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($res > 0)
  {
    $message = '<div>
     <p><b>Hello!</b></p>
     <p>This is from Baby Cake, You are recieving this email because we recieved a password reset request for your account.</p>
     <br>
     <p>Click the button Below to redirect to the page to change your password.</p>
      <br>
     <p><button class="btn btn-primary"><a href="https://babyscake.000webhostapp.com/shopping%20cart/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
if($mail->send())
{
  header("Location:forgot.php?ok=Successfully Send");
}
}
else
{
    header("Location:forgot.php?error=The email that you have been input is incorrect");
}
}
